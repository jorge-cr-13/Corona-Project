...
export class BarchartComponent implements OnInit {
  ...
  constructor(public service:CoronatrackService,
    ...
    // Initial values for the bar graph
    dtDts = [];
    dtRcv = [];
    dtCss = [];
    ...
    //Get the value for 7 days before
    day_seven = this.service.generate7Day();

    async ngOnInit(): Promise<void> {

      // Get the information of the country or world 
      ...
      // Code to create the graph for world bar graph
      if(this.country == 'world'){
        ...
        //Get the value of j corresponding to the last 7 days
